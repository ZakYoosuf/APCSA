...
public class P6 {
     ...
     * Converts Currency
     *
     * @param dollars amount of dollars being converted to other currency
     * @param exchangeRate the rate that multiplies with the dollars amount and
     * another multiplier to find the conversion rate
     * @return The product of dollars, exchangeRate, and an interest multiplier
     */
